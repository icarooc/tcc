 ...
 */
@Entity
public class FrontalOclusao implements Serializable, PersistDB {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FrontalOclusao)) {
            return false;
        }
        FrontalOclusao other = (FrontalOclusao) object;
    ...
    public String toString() {
        return "classes.FrontalOclusao[ id=" + id + " ]";
    }
