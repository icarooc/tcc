 ...
 */
@Entity
public class FrontalDesoclusao implements Serializable, PersistDB {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FrontalDesoclusao)) {
            return false;
        }
        FrontalDesoclusao other = (FrontalDesoclusao) object;
    ...
    public String toString() {
        return "classes.FrontalDesoclusao[ id=" + id + " ]";
    }
